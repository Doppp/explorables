...
The linear layer produces logits. Softmax turns them into probabilities, and cross-entropy measures how much probability the model assigned to the target. An optimiser then converts the loss gradient into a parameter update.
